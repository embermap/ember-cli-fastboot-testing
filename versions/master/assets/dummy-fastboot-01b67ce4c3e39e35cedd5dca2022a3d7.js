...
Object.defineProperty(e,"__esModule",{value:!0}),e.default={name:"error-handler",initialize:function(){Ember.onerror||(Ember.onerror=function(e){var t="There was an error running your app in fastboot. More info about the error: \n "+(e.stack||e)
console.error(t)})}}}),define("dummy/instance-initializers/setup-fetch",["exports","fetch"],function(e,t){"use strict"
