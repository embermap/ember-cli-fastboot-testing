/*! For license information please see chunk.788.52203979fa3666e0e4d9.js.LICENSE.txt */
...
default:return i(e)}}function R(e,t){return A(t)===e}function I(e,t){for(var n=e+""+t,r=0,i=0;i<n.length;i++)r=(r<<5)-r+n.charCodeAt(i),r|=0
var o=(4294967296+r).toString(16)
return o.length<8&&(o="0000000"+o),o.slice(-8)}function q(e){var t=String(e)
return"[object"===t.slice(0,7)?(e.name||"Error")+(e.message?": ".concat(e.message):""):t}var O=function(){var e=[],t=Object.getPrototypeOf||function(e){return e.__proto__}
...
return A(t)===n&&s[n](e,t)}function u(t,n){if(arguments.length<2)return!0
e=[{a:t,b:n}]
...
return e.length=0,t}}(),B={queue:[],stats:{all:0,bad:0,testCount:0},blocking:!0,failOnZeroTests:!0,reorder:!0,altertitle:!0,collapse:!0,scrolltop:!0,maxDepth:5,requireExpects:!1,urlConfig:[],modules:[],currentModule:{name:"",tests:[],childModules:[],testsRun:0,testsIgnored:0,hooks:{before:[],beforeEach:[],afterEach:[],after:[]}},globalHooks:{},callbacks:{},storage:y},P=d&&d.QUnit&&!d.QUnit.version&&d.QUnit.config
P&&M(B,P),B.modules.push(B.currentModule)
var L=function(){function e(e){return'"'+e.toString().replace(/\\/g,"\\\\").replace(/"/g,'\\"')+'"'}function t(e){return e+""}function n(e,t,n){var r=s.separator(),i=s.indent(1)
...
return this.HTML&&(t=t.replace(/\t/g,"   ").replace(/ /g,"&#160;")),new Array(this.depth+(e||0)).join(t)},up:function(e){this.depth+=e||1},down:function(e){this.depth-=e||1},setParser:function(e,t){this.parsers[e]=t},quote:e,literal:t,join:n,depth:1,maxDepth:B.maxDepth,parsers:{window:"[Window]",document:"[Document]",error:function(e){return'Error("'+e.message+'")'},unknown:"[Unknown]",null:"null",undefined:"undefined",function:function(e){var t="function",r="name"in e?e.name:(o.exec(e)||[])[1]
...
function H(e,t,n){var r=D.length?D.slice(-1)[0]:null,i=null!==r?[r.name,e].join(" > "):e,o=r?r.suiteReport:F,s=null!==r&&r.skip||n.skip,a=null!==r&&r.todo||n.todo,u={}
r&&M(u,r.testEnvironment),M(u,t)
var l={name:i,parentModule:r,hooks:{before:[],beforeEach:[],afterEach:[],after:[]},testEnvironment:u,tests:[],moduleId:I(i),testsRun:0,testsIgnored:0,childModules:[],suiteReport:new U(e,o),stats:null,skip:s,todo:!s&&a,ignored:n.ignored||!1}
return r&&r.childModules.push(l),B.modules.push(l),l}function Q(e,t,n){var r=t[n]
"function"==typeof r&&e[n].push(r),delete t[n]}function z(e,t){return function(n){B.currentModule!==e&&k.warn("The `"+t+"` hook was called inside the wrong module (`"+B.currentModule.name+"`). Instead, use hooks provided by the callback to the containing module (`"+e.name+"`). This will become an error in QUnit 3.0."),e.hooks[t].push(n)}}function $(e,t,n){var r=arguments.length>3&&void 0!==arguments[3]?arguments[3]:{}
...
var a={before:z(i,"before"),beforeEach:z(i,"beforeEach"),afterEach:z(i,"afterEach"),after:z(i,"after")},u=B.currentModule
if(B.currentModule=i,"function"===A(n)){D.push(i)
try{var l=n.call(i.testEnvironment,a)
null!=l&&"function"===A(l.then)&&k.warn("Returning a promise from a module callback is not supported. Instead, use hooks for async behavior. This will become an error in QUnit 3.0.")}finally{D.pop(),B.currentModule=i.parentModule||u}}}var G=!1
function Y(e,t,n){var r,i=G&&(r=B.modules.filter((function(e){return!e.ignored})).map((function(e){return e.moduleId})),!D.some((function(e){return r.includes(e.moduleId)})))
$(e,t,n,{ignored:i})}Y.only=function(){G||(B.modules.length=0,B.queue.length=0,B.currentModule.ignored=!0),G=!0,$.apply(void 0,arguments)},Y.skip=function(e,t,n){G||$(e,t,n,{skip:!0})},Y.todo=function(e,t,n){G||$(e,t,n,{todo:!0})}
var J=(W(0)||"").replace(/(:\d+)+\)?/,"").replace(/.+\//,"")
...
if(r.length)return r.join("\n")}return n[t]}}function W(e){var t=new Error
if(!t.stack)try{throw t}catch(e){t=e}return V(t,e)}var Z=function(){function e(t){o(this,e),this.test=t}return a(e,[{key:"timeout",value:function(e){if("number"!=typeof e)throw new Error("You must pass a number as the duration to assert.timeout")
this.test.timeout=e,B.timeout&&(m(B.timeout),B.timeout=null,B.timeoutHandler&&this.test.timeout>0&&this.test.internalResetTimeout(this.test.timeout))}},{key:"step",value:function(e){var t=e,n=!!e
...
return this.test.internalStop(t)}},{key:"push",value:function(t,n,r,i,o){return k.warn("assert.push is deprecated and will be removed in QUnit 3.0. Please use assert.pushResult instead (https://api.qunitjs.com/assert/pushResult)."),(this instanceof e?this:B.current.assert).pushResult({result:t,actual:n,expected:r,message:i,negative:o})}},{key:"pushResult",value:function(t){var n=this,r=n instanceof e&&n.test||B.current
if(!r)throw new Error("assertion outside test context, in "+W(2))
return n instanceof e||(n=r.assert),n.test.pushResult(t)}},{key:"ok",value:function(e,t){t||(t=e?"okay":"failed, expected argument to be truthy, was: ".concat(L.parse(e))),this.pushResult({result:!!e,actual:e,expected:!0,message:t})}},{key:"notOk",value:function(e,t){t||(t=e?"failed, expected argument to be falsy, was: ".concat(L.parse(e)):"okay"),this.pushResult({result:!e,actual:e,expected:!1,message:t})}},{key:"true",value:function(e,t){this.pushResult({result:!0===e,actual:e,expected:!0,message:t})}},{key:"false",value:function(e,t){this.pushResult({result:!1===e,actual:e,expected:!1,message:t})}},{key:"equal",value:function(e,t,n){var r=t==e
this.pushResult({result:r,actual:e,expected:t,message:n})}},{key:"notEqual",value:function(e,t,n){var r=t!=e
this.pushResult({result:r,actual:e,expected:t,message:n,negative:!0})}},{key:"propEqual",value:function(e,t,n){e=S(e),t=S(t),this.pushResult({result:O(e,t),actual:e,expected:t,message:n})}},{key:"notPropEqual",value:function(e,t,n){e=S(e),t=S(t),this.pushResult({result:!O(e,t),actual:e,expected:t,message:n,negative:!0})}},{key:"propContains",value:function(e,t,n){e=N(e,t),t=S(t,!1),this.pushResult({result:O(e,t),actual:e,expected:t,message:n})}},{key:"notPropContains",value:function(e,t,n){e=N(e,t),t=S(t),this.pushResult({result:!O(e,t),actual:e,expected:t,message:n,negative:!0})}},{key:"deepEqual",value:function(e,t,n){this.pushResult({result:O(e,t),actual:e,expected:t,message:n})}},{key:"notDeepEqual",value:function(e,t,n){this.pushResult({result:!O(e,t),actual:e,expected:t,message:n,negative:!0})}},{key:"strictEqual",value:function(e,t,n){this.pushResult({result:t===e,actual:e,expected:t,message:n})}},{key:"notStrictEqual",value:function(e,t,n){this.pushResult({result:t!==e,actual:e,expected:t,message:n,negative:!0})}},{key:"throws",value:function(t,n,r){var i=u(X(n,r,"throws"),2)
n=i[0],r=i[1]
var o=this instanceof e&&this.test||B.current
if("function"===A(t)){var s,a=!1
o.ignoreGlobalErrors=!0
try{t.call(o.testEnvironment)}catch(e){s=e}if(o.ignoreGlobalErrors=!1,s){var l=u(K(s,n,r),3)
a=l[0],n=l[1],r=l[2]}o.assert.pushResult({result:a,actual:s&&q(s),expected:n,message:r})}else{var c='The value provided to `assert.throws` in "'+o.testName+'" was not a function.'
o.assert.pushResult({result:!1,actual:t,message:c})}}},{key:"rejects",value:function(t,n,r){var i=u(X(n,r,"rejects"),2)
n=i[0],r=i[1]
var o=this instanceof e&&this.test||B.current,s=t&&t.then
...
t=i[0],n=i[1],r=i[2],o.assert.pushResult({result:t,actual:e&&q(e),expected:n,message:r}),a()}))}var l='The value provided to `assert.rejects` in "'+o.testName+'" was not a promise.'
o.assert.pushResult({result:!1,message:l,actual:t})}}]),e}()
function X(e,t,n){var r=A(e)
if("string"===r){if(void 0===t)return t=e,[e=void 0,t]
throw new Error("assert."+n+" does not accept a string value for the expected argument.\nUse a non-string object value (e.g. RegExp or validator function) instead if necessary.")}if(e&&"regexp"!==r&&"function"!==r&&"object"!==r)throw new Error("Invalid expected value type ("+r+") provided to assert."+n+".")
return[e,t]}function K(e,t,n){var r=!1,i=A(t)
if(t){if("regexp"===i)r=t.test(q(e)),t=String(t)
else if("function"===i&&void 0!==t.prototype&&e instanceof t)r=!0
else if("object"===i)r=e instanceof t.constructor&&e.name===t.name&&e.message===t.message,t=q(t)
else if("function"===i)try{r=!0===t.call({},e),t=null}catch(e){t=q(e)}}else r=!0
...
function ne(e,t){if("string"!==A(e))throw new TypeError("eventName must be a string when emitting an event")
...
n=!0,u(t,e)}}}()
var oe=ie.exports
function se(e,t){var n=B.callbacks[e]
...
function ce(){var e,t
e=C.now(),B.depth=(B.depth||0)+1,fe(e),B.depth--,le.length||B.blocking||B.current||(B.blocking||B.queue.length||0!==B.depth?(t=B.queue.shift()(),le.push.apply(le,l(t)),ue>0&&ue--,ce()):function(){var e
if(0===B.stats.testCount&&!0===B.failOnZeroTests)return e=B.filter&&B.filter.length?new Error('No tests matched the filter "'.concat(B.filter,'".')):B.module&&B.module.length?new Error('No tests matched the module "'.concat(B.module,'".')):B.moduleId&&B.moduleId.length?new Error('No tests matched the moduleId "'.concat(B.moduleId,'".')):B.testId&&B.testId.length?new Error('No tests matched the testId "'.concat(B.testId,'".')):new Error("No tests were run."),we("global failure",M((function(t){t.pushResult({result:!1,message:e.message,source:e.stack})}),{validTest:!0})),void ce()
var t=B.storage,n=C.now()-B.started,r=B.stats.all-B.stats.bad
de.finished=!0,ne("runEnd",F.end(!0)),se("done",{passed:r,failed:B.stats.bad,total:B.stats.all,runtime:n}).then((function(){if(t&&0===B.stats.bad)for(var e=t.length-1;e>=0;e--){var n=t.key(e)
0===n.indexOf("qunit-test-")&&t.removeItem(n)}}))}())}function fe(e){if(le.length&&!B.blocking){var t=C.now()-e
if(!g||B.updateRate<=0||t<B.updateRate){var n=le.shift()
oe.resolve(n()).then((function(){le.length?fe(e):ce()}))}else g(ce)}}var de={finished:!1,add:function(e,t,n){if(t)B.queue.splice(ue++,0,e)
else if(n){ae||(ae=function(e){var t=parseInt(I(e),16)||-1
return function(){return t^=t<<13,t^=t>>>17,(t^=t<<5)<0&&(t+=4294967296),t/4294967296}}(n))
var r=Math.floor(ae()*(B.queue.length-ue+1))
B.queue.splice(ue+r,0,e)}else B.queue.push(e)},advance:ce,taskCount:function(){return le.length}},he=function(){function e(t,n,r){o(this,e),this.name=t,this.suiteName=n.name,this.fullName=n.fullName.concat(t),this.runtime=0,this.assertions=[],this.skipped=!!r.skip,this.todo=!!r.todo,this.valid=r.valid,this._startTime=0,this._endTime=0,n.pushTest(this)}return a(e,[{key:"start",value:function(e){return e&&(this._startTime=C.now(),C.mark("qunit_test_start")),{name:this.name,suiteName:this.suiteName,fullName:this.fullName.slice()}}},{key:"end",value:function(e){if(e&&(this._endTime=C.now(),C)){C.mark("qunit_test_end")
var t=this.fullName.join(" – ")
C.measure("QUnit Test: ".concat(t),"qunit_test_start","qunit_test_end")}return M(this.start(),{runtime:this.getRuntime(),status:this.getStatus(),errors:this.getFailedAssertions(),assertions:this.getAssertions()})}},{key:"pushAssertion",value:function(e){this.assertions.push(e)}},{key:"getRuntime",value:function(){return this._endTime-this._startTime}},{key:"getStatus",value:function(){return this.skipped?"skipped":(this.getFailedAssertions().length>0?this.todo:!this.todo)?this.todo?"todo":"passed":"failed"}},{key:"getFailedAssertions",value:function(){return this.assertions.filter((function(e){return!e.passed}))}},{key:"getAssertions",value:function(){return this.assertions.slice()}},{key:"slimAssertions",value:function(){this.assertions=this.assertions.map((function(e){return delete e.actual,delete e.expected,e}))}}]),e}()
function pe(e){if(this.expected=null,this.assertions=[],this.module=B.currentModule,this.steps=[],this.timeout=void 0,this.data=void 0,this.withData=!1,this.pauses=new w,this.nextPauseId=1,this.stackOffset=3,M(this,e),this.module.skip?(this.skip=!0,this.todo=!1):this.module.todo&&!this.skip&&(this.todo=!0),de.finished)k.warn("Unexpected test after runEnd. This is unstable and will fail in QUnit 3.0.")
...
this.testId=I(this.module.name,this.testName),this.module.tests.push({name:this.testName,testId:this.testId,skip:!!this.skip}),this.skip?(this.callback=function(){},this.async=!1,this.expected=0):this.assert=new Z(this)}}function ge(){if(!B.current)throw new Error("pushFailure() assertion outside test context, in "+W(2))
var e=B.current
return e.pushFailure.apply(e,arguments)}function me(){if(B.pollution=[],B.noglobals)for(var e in d)if(E.call(d,e)){if(/^qunit-test-output/.test(e))continue
B.pollution.push(e)}}pe.count=0,pe.prototype={get stack(){return V(this.errorForStack,this.stackOffset)},before:function(){var e=this,t=this.module,n=function(e){for(var t=e,n=[];t&&0===t.testsRun;)n.push(t),t=t.parentModule
return n.reverse()}(t)
return n.reduce((function(e,t){return e.then((function(){return t.stats={all:0,bad:0,started:C.now()},ne("suiteStart",t.suiteReport.start(!0)),se("moduleStart",{name:t.name,tests:t.tests})}))}),oe.resolve([])).then((function(){return B.current=e,e.testEnvironment=M({},t.testEnvironment),e.started=C.now(),ne("testStart",e.testReport.start(!0)),se("testStart",{name:e.testName,module:t.name,testId:e.testId,previousFailure:e.previousFailure}).then((function(){B.pollution||me()}))}))},run:function(){if(B.current=this,B.notrycatch)e(this)
else try{e(this)}catch(e){this.pushFailure("Died on test #"+(this.assertions.length+1)+": "+(e.message||e)+"\n"+this.stack,V(e,0)),me(),B.blocking&&Ee(this)}function e(e){var t
t=e.withData?e.callback.call(e.testEnvironment,e.assert,e.data):e.callback.call(e.testEnvironment,e.assert),e.resolvePromise(t),0===e.timeout&&e.pauses.size>0&&ge("Test did not finish synchronously even though assert.timeout( 0 ) was used.",W(2))}},after:function(){!function(){var e=B.pollution
me()
var t=_(B.pollution,e)
t.length>0&&ge("Introduced global variable(s): "+t.join(", "))
var n=_(e,B.pollution)
n.length>0&&ge("Deleted global variable(s): "+n.join(", "))}()},queueGlobalHook:function(e,t){var n=this
return function(){var r
if(B.current=n,B.notrycatch)r=e.call(n.testEnvironment,n.assert)
else try{r=e.call(n.testEnvironment,n.assert)}catch(e){return void n.pushFailure("Global "+t+" failed on "+n.testName+": "+q(e),V(e,0))}n.resolvePromise(r,t)}},queueHook:function(e,t,n){var r=this,i=function(){var n=e.call(r.testEnvironment,r.assert)
r.resolvePromise(n,t)}
return function(){if("before"===t){if(0!==n.testsRun)return
r.preserveEnvironment=!0}if("after"!==t||function(e){return e.testsRun===Ce(e).filter((function(e){return!e.skip})).length-1}(n)||!(B.queue.length>0||de.taskCount()>2))if(B.current=r,B.notrycatch)i()
else try{i()}catch(e){r.pushFailure(t+" failed on "+r.testName+": "+(e.message||e),V(e,0))}}},hooks:function(e){var t=[]
return this.skip||(function(n){if(("beforeEach"===e||"afterEach"===e)&&B.globalHooks[e])for(var r=0;r<B.globalHooks[e].length;r++)t.push(n.queueGlobalHook(B.globalHooks[e][r],e))}(this),function n(r,i){if(i.parentModule&&n(r,i.parentModule),i.hooks[e].length)for(var o=0;o<i.hooks[e].length;o++)t.push(r.queueHook(i.hooks[e][o],e,i))}(this,this.module)),t},finish:function(){if(B.current=this,this.callback=void 0,this.steps.length){var e=this.steps.join(", ")
this.pushFailure("Expected assert.verifySteps() to be called before end of test "+"after using assert.step(). Unverified steps: ".concat(e),this.stack)}B.requireExpects&&null===this.expected?this.pushFailure("Expected number of assertions to be defined, but expect() was not called.",this.stack):null!==this.expected&&this.expected!==this.assertions.length?this.pushFailure("Expected "+this.expected+" assertions, but "+this.assertions.length+" were run",this.stack):null!==this.expected||this.assertions.length||this.pushFailure("Expected at least one assertion, but none were run - call expect(0) to accept zero assertions.",this.stack)
var t=this.module,n=t.name,r=this.testName,i=!!this.skip,o=!!this.todo,s=0,a=B.storage
this.runtime=C.now()-this.started,B.stats.all+=this.assertions.length,B.stats.testCount+=1,t.stats.all+=this.assertions.length
for(var u=0;u<this.assertions.length;u++)this.assertions[u].result||(s++,B.stats.bad++,t.stats.bad++)
...
if(E.call(e,"expected")&&(r.expected=e.expected),!e.result){var i=e.source||W()
i&&(r.source=i)}this.logAssertion(r),this.assertions.push({result:!!e.result,message:e.message})},pushFailure:function(e,t,n){if(!(this instanceof pe))throw new Error("pushFailure() assertion outside test context, was "+W(2))
this.pushResult({result:!1,message:e||"error",actual:n||null,source:t})},logAssertion:function(e){se("log",e)
var t={passed:e.result,actual:e.actual,expected:e.expected,message:e.message,stack:e.source,todo:e.todo}
this.testReport.pushAssertion(t),ne("assertion",t)},internalResetTimeout:function(e){m(B.timeout),B.timeout=g(B.timeoutHandler(e),e)},internalStop:function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:1
B.blocking=!0
var t,n=this,r=this.nextPauseId++,i={cancelled:!1,remaining:e}
function o(){if(!i.cancelled){if(void 0===B.current)throw new Error("Unexpected release of async pause after tests finished.\n"+"> Test: ".concat(n.testName," [async #").concat(r,"]"))
if(B.current!==n)throw new Error("Unexpected release of async pause during a different test.\n"+"> Test: ".concat(n.testName," [async #").concat(r,"]"))
if(i.remaining<=0)throw new Error("Tried to release async pause that was already released.\n"+"> Test: ".concat(n.testName," [async #").concat(r,"]"))
i.remaining--,0===i.remaining&&n.pauses.delete(r),Te(n)}}return n.pauses.set(r,i),g&&("number"==typeof n.timeout?t=n.timeout:"number"==typeof B.testTimeout&&(t=B.testTimeout),"number"==typeof t&&t>0&&(B.timeoutHandler=function(e){return function(){B.timeout=null,i.cancelled=!0,n.pauses.delete(r),n.pushFailure("Test took longer than ".concat(e,"ms; test timed out."),W(2)),Te(n)}},m(B.timeout),B.timeout=g(B.timeoutHandler(t),t))),o},resolvePromise:function(e,t){if(null!=e){var n=this,r=e.then
if("function"===A(r)){var i=n.internalStop(),o=function(){i()}
B.notrycatch?r.call(e,o):r.call(e,o,(function(e){var r="Promise rejected "+(t?t.replace(/Each$/,""):"during")+' "'+n.testName+'": '+(e&&e.message||e)
n.pushFailure(r,V(e,0)),me(),Ee(n)}))}}},valid:function(){var e=B.filter,t=/^(!?)\/([\w\W]*)\/(i?$)/.exec(e),n=B.module&&B.module.toLowerCase(),r=this.module.name+": "+this.testName
return!(!this.callback||!this.callback.validTest)||!(B.moduleId&&B.moduleId.length>0&&!function e(t){return j(t.moduleId,B.moduleId)||t.parentModule&&e(t.parentModule)}(this.module))&&!(B.testId&&B.testId.length>0&&!j(this.testId,B.testId))&&!(n&&!function e(t){return(t.name?t.name.toLowerCase():null)===n||!!t.parentModule&&e(t.parentModule)}(this.module))&&(!e||(t?this.regexFilter(!!t[1],t[2],t[3],r):this.stringFilter(e,r)))},regexFilter:function(e,t,n,r){return new RegExp(t,n).test(r)!==e},stringFilter:function(e,t){e=e.toLowerCase(),t=t.toLowerCase()
var n="!"!==e.charAt(0)
return n||(e=e.slice(1)),-1!==t.indexOf(e)?n:!n}}
var ve=!1
function be(e){ve||B.currentModule.ignored||new pe(e).queue()}function ye(e){B.currentModule.ignored||(ve||(B.queue.length=0,ve=!0),new pe(e).queue())}function we(e,t){be({testName:e,callback:t})}function ke(e,t){return"".concat(e," [").concat(t,"]")}function xe(e,t){if(Array.isArray(e))for(var n=0;n<e.length;n++)t(e[n],n)
else{if("object"!==i(e)||null===e)throw new Error("test.each() expects an array or object as input, but\nfound ".concat(i(e)," instead."))
for(var r in e)t(e[r],r)}}function Ee(e){e.pauses.forEach((function(e){e.cancelled=!0})),e.pauses.clear(),Te(e)}function Te(e){e.pauses.size>0||(g?(m(B.timeout),B.timeout=g((function(){e.pauses.size>0||(m(B.timeout),B.timeout=null,B.blocking=!1,de.advance())}))):(B.blocking=!1,de.advance()))}function Ce(e){for(var t=[].concat(e.tests),n=l(e.childModules);n.length;){var r=n.shift()
t.push.apply(t,r.tests),n.push.apply(n,l(r.childModules))}return t}function _e(e){return e.testsRun+e.testsIgnored===Ce(e).length}function je(e){for(e.testsIgnored++;e=e.parentModule;)e.testsIgnored++}M(we,{todo:function(e,t){be({testName:e,callback:t,todo:!0})},skip:function(e){be({testName:e,skip:!0})},only:function(e,t){ye({testName:e,callback:t})},each:function(e,t,n){xe(t,(function(t,r){be({testName:ke(e,r),callback:n,withData:!0,stackOffset:5,data:t})}))}}),we.todo.each=function(e,t,n){xe(t,(function(t,r){be({testName:ke(e,r),callback:n,todo:!0,withData:!0,stackOffset:5,data:t})}))},we.skip.each=function(e,t){xe(t,(function(t,n){be({testName:ke(e,n),stackOffset:5,skip:!0})}))},we.only.each=function(e,t,n){xe(t,(function(t,r){ye({testName:ke(e,r),callback:n,withData:!0,stackOffset:5,data:t})}))}
var Se,Ne,Me,Ae,Re=function(){function e(t){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}
...
Se=qe.FORCE_COLOR,Ne=qe.NODE_DISABLE_COLORS,Me=qe.NO_COLOR,Ae=qe.TERM,Ie=process.stdout&&process.stdout.isTTY}var Oe={enabled:!Ne&&null==Me&&"dumb"!==Ae&&(null!=Se&&"0"!==Se||Ie),reset:Pe(0,0),bold:Pe(1,22),dim:Pe(2,22),italic:Pe(3,23),underline:Pe(4,24),inverse:Pe(7,27),hidden:Pe(8,28),strikethrough:Pe(9,29),black:Pe(30,39),red:Pe(31,39),green:Pe(32,39),yellow:Pe(33,39),blue:Pe(34,39),magenta:Pe(35,39),cyan:Pe(36,39),white:Pe(37,39),gray:Pe(90,39),grey:Pe(90,39),bgBlack:Pe(40,49),bgRed:Pe(41,49),bgGreen:Pe(42,49),bgYellow:Pe(43,49),bgBlue:Pe(44,49),bgMagenta:Pe(45,49),bgCyan:Pe(46,49),bgWhite:Pe(47,49)}
...
t+="\n  message: ".concat(Ue(q(e))),t+="\n  severity: ".concat(Ue("failed")),e&&e.stack&&(t+="\n  stack: ".concat(Ue(e.stack+"\n"))),t+="\n  ...",this.log(t)}}],[{key:"init",value:function(t,n){return new e(t,n)}}]),e}(),He={console:Re,tap:Fe}
function Qe(e){return function(t){B.globalHooks[e]||(B.globalHooks[e]=[]),B.globalHooks[e].push(t)}}var ze={beforeEach:Qe("beforeEach"),afterEach:Qe("afterEach")}
function $e(e){B.current?B.current.assert.pushResult({result:!1,message:"global failure: ".concat(q(e)),source:e&&e.stack||W(2)}):(F.globalFailureCount++,B.stats.bad++,B.stats.all++,ne("error",e))}var Ge={}
B.currentModule.suiteReport=F
var Ye=!1,Je=!1
function Ve(){Je=!0,g?g((function(){Ze()})):Ze()}function We(){B.blocking=!1,de.advance()}function Ze(){if(B.started)We()
else{B.started=C.now(),""===B.modules[0].name&&0===B.modules[0].tests.length&&B.modules.shift()
for(var e=B.modules.length,t=[],n=0;n<e;n++)t.push({name:B.modules[n].name,tests:B.modules[n].tests})
ne("runStart",F.start(!0)),se("begin",{totalTests:pe.count,modules:t}).then(We)}}Ge.isLocal=h&&h.location&&"file:"===h.location.protocol,Ge.version="2.18.2",M(Ge,{config:B,dump:L,equiv:O,reporters:He,hooks:ze,is:R,objectType:A,on:function(e,t){if("string"!==A(e))throw new TypeError("eventName must be a string when registering a listener")
...
ee[e]||(ee[e]=[]),j(t,ee[e])||ee[e].push(t)},onError:function(e){if(k.warn("QUnit.onError is deprecated and will be removed in QUnit 3.0. Please use QUnit.onUncaughtException instead."),B.current&&B.current.ignoreGlobalErrors)return!0
var t=new Error(e.message)
return t.stack=e.stacktrace||e.fileName+":"+e.lineNumber,$e(t),!1},onUncaughtException:$e,pushFailure:ge,assert:Z.prototype,module:Y,test:we,todo:we.todo,skip:we.skip,only:we.only,start:function(e){if(B.current)throw new Error("QUnit.start cannot be called inside a test context.")
var t=Ye
if(Ye=!0,Je)throw new Error("Called start() while test already started running")
...
if(!B.pageLoaded)return B.autostart=!0,void(v||Ge.load())
Ve()},onUnhandledRejection:function(e){k.warn("QUnit.onUnhandledRejection is deprecated and will be removed in QUnit 3.0. Please use QUnit.onUncaughtException instead."),$e(e)},extend:function(){k.warn("QUnit.extend is deprecated and will be removed in QUnit 3.0. Please use Object.assign instead.")
for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n]
return M.apply(this,t)},load:function(){B.pageLoaded=!0,M(B,{started:0,updateRate:1e3,autostart:!0,filter:""},!0),Je||(B.blocking=!1,B.autostart&&Ve())},stack:function(e){return W(e=(e||0)+2)}}),function(e){var t=["begin","done","log","testStart","testDone","moduleStart","moduleDone"]
...
B.callbacks[e].push(t)}}for(var r=0,i=t.length;r<i;r++){var o=t[r]
"undefined"===A(B.callbacks[o])&&(B.callbacks[o]=[]),e[o]=n(o)}}(Ge),function(i){if(h&&v){if(h.QUnit&&h.QUnit.version)throw new Error("QUnit has already been defined.")
...
if(n&&n.keys)for(var v=n.scoreFn||l,b=n.keys,y=b.length,w=m-1;w>=0;--w){for(var k=t[w],x=new Array(y),E=y-1;E>=0;--E)(_=c(k,C=b[E]))?(f(_)||(_=p.getPrepared(_)),x[E]=u(e,_,r)):x[E]=null
x.obj=k
var T=v(x)
null!==T&&(T<s||(x.score=T,d<a?(h.add(x),++d):(++g,T>h.peek().score&&h.replaceTop(x))))}else if(n&&n.key){var C=n.key
for(w=m-1;w>=0;--w)(_=c(k=t[w],C))&&(f(_)||(_=p.getPrepared(_)),null!==(j=u(e,_,r))&&(j.score<s||(j={target:j.target,_targetLowerCodes:null,_nextBeginningIndexes:null,score:j.score,indexes:j.indexes,obj:k},d<a?(h.add(j),++d):(++g,j.score>h.peek().score&&h.replaceTop(j)))))}else for(w=m-1;w>=0;--w){var _,j;(_=t[w])&&(f(_)||(_=p.getPrepared(_)),null!==(j=u(e,_,r))&&(j.score<s||(d<a?(h.add(j),++d):(++g,j.score>h.peek().score&&h.replaceTop(j)))))}if(0===d)return o
var S=new Array(d)
...
for(var R=new Array(w),I=w-1;I>=0;--I)R[I]=g.poll()
...
var Ke=Xe.exports,et={failedTests:[],defined:0,completed:0}
function tt(e){return e?(""+e).replace(/['"<>&]/g,(function(e){switch(e){case"'":return"&#039;"
case'"':return"&quot;"
case"<":return"&lt;"
case">":return"&gt;"
case"&":return"&amp;"}})):""}!function(){if(h&&v){var e=Ge.config,t=[],n=!1,r=Object.prototype.hasOwnProperty,i=S({filter:void 0,module:void 0,moduleId:void 0,testId:void 0}),o=null
Ge.on("runStart",(function(e){et.defined=e.testCounts.total})),Ge.begin((function(){var t,n,s,a,u,c,f,p,y,E,S;(c=T("qunit"))&&(c.setAttribute("role","main"),c.innerHTML="<h1 id='qunit-header'>"+tt(v.title)+"</h1><h2 id='qunit-banner'></h2><div id='qunit-testrunner-toolbar' role='navigation'></div>"+(!(t=Ge.config.testId)||t.length<=0?"":"<div id='qunit-filteredTest'>Rerunning selected tests: "+tt(t.join(", "))+" <a id='qunit-clearFilter' href='"+tt(i)+"'>Run all tests</a></div>")+"<h2 id='qunit-userAgent'></h2><ol id='qunit-tests'></ol>"),(n=T("qunit-header"))&&(n.innerHTML="<a href='"+tt(i)+"'>"+n.innerHTML+"</a> "),(s=T("qunit-banner"))&&(s.className=""),E=T("qunit-tests"),(S=T("qunit-testresult"))&&S.parentNode.removeChild(S),E&&(E.innerHTML="",(S=v.createElement("p")).id="qunit-testresult",S.className="result",E.parentNode.insertBefore(S,E),S.innerHTML='<div id="qunit-testresult-display">Running...<br />&#160;</div><div id="qunit-testresult-controls"></div><div class="clearfix"></div>',p=T("qunit-testresult-controls")),p&&p.appendChild(((y=v.createElement("button")).id="qunit-abort-tests-button",y.innerHTML="Abort",d(y,"click",C),y)),(a=T("qunit-userAgent"))&&(a.innerHTML="",a.appendChild(v.createTextNode("QUnit "+Ge.version+"; "+b.userAgent))),(u=T("qunit-testrunner-toolbar"))&&(u.appendChild(((f=v.createElement("span")).innerHTML=function(){for(var t=!1,n=e.urlConfig,i="",o=0;o<n.length;o++){var s=e.urlConfig[o]
...
e[s.id]&&!t&&(i+="<option value='"+(a=tt(e[s.id]))+"' selected='selected' disabled='disabled'>"+a+"</option>"),i+="</select>"}else i+="<label for='qunit-urlconfig-"+a+"' title='"+u+"'><input id='qunit-urlconfig-"+a+"' name='"+a+"' type='checkbox'"+(s.value?" value='"+tt(s.value)+"'":"")+(e[s.id]?" checked='checked'":"")+" title='"+u+"' />"+tt(s.label)+"</label>"}return i}(),k(f,"qunit-url-config"),m(f.getElementsByTagName("input"),"change",j),m(f.getElementsByTagName("select"),"change",j),f)),u.appendChild(function(){var t,n,r,i,s=v.createElement("span")
return s.id="qunit-toolbar-filters",s.appendChild((t=v.createElement("form"),n=v.createElement("label"),r=v.createElement("input"),i=v.createElement("button"),k(t,"qunit-filter"),n.innerHTML="Filter: ",r.type="text",r.value=e.filter||"",r.name="filter",r.id="qunit-filter-input",i.innerHTML="Go",n.appendChild(r),t.appendChild(n),t.appendChild(v.createTextNode(" ")),t.appendChild(i),d(t,"submit",_),t)),s.appendChild(function(){var t=null
o={options:[],selectedMap:new w,isDirty:function(){return l(o.selectedMap.keys()).sort().join(",")!==l(t.keys()).sort().join(",")}}
for(var n=0;n<e.modules.length;n++){var r=e.modules[n]
""!==r.name&&(o.options.push({moduleId:r.moduleId,name:r.name}),-1!==e.moduleId.indexOf(r.moduleId)&&o.selectedMap.set(r.moduleId,r.name))}t=new w(o.selectedMap)
...
u.textContent="Apply",u.title="Re-run the selected test modules",d(u,"click",N)
...
var y,k=v.createElement("form")
function E(){function e(t){var n=k.contains(t.target)
...
o.selectedMap.forEach((function(e,n){t+=A(n,e,!0)}))
for(var n=0;n<e.length;n++){var r=e[n].obj
o.selectedMap.has(r.moduleId)||(t+=A(r.moduleId,r.name,!1))}return t}(""===e?o.options.slice(0,20).map((function(e){return{obj:e}})):Ke.go(e,o.options,{limit:20,key:"name",allowTypo:!0}))}(i.value)}))}function C(e){var t=e&&e.target||null
...
i.placeholder=n,i.title="Type to search through and reduce the list.",c.disabled=!o.isDirty(),f.style.display=o.selectedMap.size?"":"none"}return k.id="qunit-modulefilter",k.appendChild(s),k.appendChild(v.createTextNode(" ")),k.appendChild(a),d(k,"submit",_),d(k,"reset",(function(){o.selectedMap=new w(t),C(),T()})),k}()),s}()),u.appendChild(v.createElement("div")).className="clearfix")})),Ge.on("runEnd",(function(t){var n,r,i,o=T("qunit-banner"),s=T("qunit-tests"),a=T("qunit-abort-tests-button"),u=e.stats.all-e.stats.bad,l=[t.testCounts.total," tests completed in ",Math.round(t.runtime)," milliseconds, with ",t.testCounts.failed," failed, ",t.testCounts.skipped," skipped, and ",t.testCounts.todo," todo.<br />","<span class='passed'>",u,"</span> assertions of <span class='total'>",e.stats.all,"</span> passed, <span class='failed'>",e.stats.bad,"</span> failed.",I(et.failedTests)].join("")
...
R(e.name,e.testId,e.module),(t=T("qunit-testresult-display"))&&(k(t,"running"),n=Ge.config.reorder&&e.previousFailure,t.innerHTML=[B(et),n?"Rerunning previously failed test: <br />":"Running: ",O(e.name,e.module),I(et.failedTests)].join(""))})),Ge.log((function(e){var t=T("qunit-test-output-"+e.testId)
...
c?k(a,"qunit-collapsed"):(et.failedTests.push(r.testId),e.collapse&&(n?k(a,"qunit-collapsed"):n=!0))
...
b.innerHTML="<strong>Source: </strong>"+tt(r.source),k(b,"qunit-source"),c&&k(b,"qunit-collapsed"),d(f,"click",(function(){x(b,"qunit-collapsed")})),o.appendChild(b)}e.hidepassed&&("passed"===s||r.skipped)&&(t.push(o),i.removeChild(o))}})),Ge.on("error",(function(e){var t=R("global failure")
if(t){var n=tt(q(e))
...
return e&&(e.disabled=!0,e.innerHTML="Aborting..."),Ge.config.queue.length=0,!1}function _(e){var t=T("qunit-filter-input")
return t.value=f(t.value),N(),e&&e.preventDefault&&e.preventDefault(),!1}function j(){var n,r=this,i={}
...
h.location=S({filter:""===e?void 0:e,moduleId:l(o.selectedMap.keys()),module:void 0,testId:void 0})}function A(e,t,n){return'<li><label class="clickable'+(n?" checked":"")+'"><input type="checkbox" value="'+tt(e)+'"'+(n?' checked="checked"':"")+" />"+tt(t)+"</label></li>"}function R(e,t,n){var r=T("qunit-tests")
...
return a.className="qunit-assert-list",o.appendChild(a),r.appendChild(o),o}}function I(e){return 0===e.length?"":["<br /><a href='"+tt(S({testId:e}))+"'>",1===e.length?"Rerun 1 failed test":"Rerun "+e.length+" failed tests","</a>"].join("")}function O(e,t){var n=""
return t&&(n="<span class='module-name'>"+tt(t)+"</span>: "),n+"<span class='test-name'>"+tt(e)+"</span>"}function B(e){return[e.completed," / ",e.defined," tests completed.<br />"].join("")}function P(e){return e.replace(/<\/?[^>]+(>|$)/g,"").replace(/&quot;/g,"").replace(/\s+/g,"")}}(),Ge.diff=function(){function e(){}var t=-1,n=Object.prototype.hasOwnProperty
...
a+=i.length}u=0,l=0,f="",c=""}a++}return o.pop(),o},e.prototype.diffBisect=function(e,n,r){var i,o,s,a,u,l,c,f,d,h,p,g,m,v,b,y,w,k,x,E,T,C,_
for(i=e.length,o=n.length,a=s=Math.ceil((i+o)/2),u=2*s,l=new Array(u),c=new Array(u),f=0;f<u;f++)l[f]=-1,c[f]=-1
for(l[a+1]=0,c[a+1]=0,h=(d=i-o)%2!=0,p=0,g=0,m=0,v=0,T=0;T<s&&!((new Date).getTime()>r);T++){for(C=-T+p;C<=T-g;C+=2){for(y=a+C,x=(w=C===-T||C!==T&&l[y-1]<l[y+1]?l[y+1]:l[y-1]+1)-C;w<i&&x<o&&e.charAt(w)===n.charAt(x);)w++,x++
if(l[y]=w,w>i)g+=2
else if(x>o)p+=2
else if(h&&(b=a+d-C)>=0&&b<u&&-1!==c[b]&&w>=(k=i-c[b]))return this.diffBisectSplit(e,n,w,x,r)}for(_=-T+m;_<=T-v;_+=2){for(b=a+_,E=(k=_===-T||_!==T&&c[b-1]<c[b+1]?c[b+1]:c[b-1]+1)-_;k<i&&E<o&&e.charAt(i-k-1)===n.charAt(o-E-1);)k++,E++
if(c[b]=k,k>i)v+=2
else if(E>o)m+=2
else if(!h&&(y=a+d-_)>=0&&y<u&&-1!==l[y]&&(x=a+(w=l[y])-y,w>=(k=i-k)))return this.diffBisectSplit(e,n,w,x,r)}}return[[t,e],[1,n]]},e.prototype.diffBisectSplit=function(e,t,n,r,i){var o,s,a,u,l,c
...
n.r(t),n.d(t,{DOMException:()=>C,Headers:()=>p,Request:()=>k,Response:()=>E,fetch:()=>_})
var r="undefined"!=typeof globalThis&&globalThis||"undefined"!=typeof self&&self||void 0!==r&&r,i="URLSearchParams"in r,o="Symbol"in r&&"iterator"in Symbol,s="FileReader"in r&&"Blob"in r&&function(){try{return new Blob,!0}catch(e){return!1}}(),a="FormData"in r,u="ArrayBuffer"in r
...
return o&&(t[Symbol.iterator]=function(){return t}),t}function p(e){this.map={},e instanceof p?e.forEach((function(e,t){this.append(t,e)}),this):Array.isArray(e)?e.forEach((function(e){this.append(e[0],e[1])}),this):e&&Object.getOwnPropertyNames(e).forEach((function(t){this.append(t,e[t])}),this)}function g(e){if(e.bodyUsed)return Promise.reject(new TypeError("Already read"))
e.bodyUsed=!0}function m(e){return new Promise((function(t,n){e.onload=function(){t(e.result)},e.onerror=function(){n(e.error)}}))}function v(e){var t=new FileReader,n=m(t)
...
this.bodyUsed=this.bodyUsed,this._bodyInit=e,e?"string"==typeof e?this._bodyText=e:s&&Blob.prototype.isPrototypeOf(e)?this._bodyBlob=e:a&&FormData.prototype.isPrototypeOf(e)?this._bodyFormData=e:i&&URLSearchParams.prototype.isPrototypeOf(e)?this._bodyText=e.toString():u&&s&&(t=e)&&DataView.prototype.isPrototypeOf(t)?(this._bodyArrayBuffer=b(e.buffer),this._bodyInit=new Blob([this._bodyArrayBuffer])):u&&(ArrayBuffer.prototype.isPrototypeOf(e)||c(e))?this._bodyArrayBuffer=b(e):this._bodyText=e=Object.prototype.toString.call(e):this._bodyText="",this.headers.get("content-type")||("string"==typeof e?this.headers.set("content-type","text/plain;charset=UTF-8"):this._bodyBlob&&this._bodyBlob.type?this.headers.set("content-type",this._bodyBlob.type):i&&URLSearchParams.prototype.isPrototypeOf(e)&&this.headers.set("content-type","application/x-www-form-urlencoded;charset=UTF-8"))},s&&(this.blob=function(){var e=g(this)
if(e)return e
if(this._bodyBlob)return Promise.resolve(this._bodyBlob)
if(this._bodyArrayBuffer)return Promise.resolve(new Blob([this._bodyArrayBuffer]))
if(this._bodyFormData)throw new Error("could not read FormData body as blob")
return Promise.resolve(new Blob([this._bodyText]))},this.arrayBuffer=function(){return this._bodyArrayBuffer?g(this)||(ArrayBuffer.isView(this._bodyArrayBuffer)?Promise.resolve(this._bodyArrayBuffer.buffer.slice(this._bodyArrayBuffer.byteOffset,this._bodyArrayBuffer.byteOffset+this._bodyArrayBuffer.byteLength)):Promise.resolve(this._bodyArrayBuffer)):this.blob().then(v)}),this.text=function(){var e,t,n,r=g(this)
if(r)return r
...
return Promise.resolve(this._bodyText)},a&&(this.formData=function(){return this.text().then(x)}),this.json=function(){return this.text().then(JSON.parse)},this}p.prototype.append=function(e,t){e=f(e),t=d(t)
var n=this.map[e]
...
return this.forEach((function(t,n){e.push([n,t])})),h(e)},o&&(p.prototype[Symbol.iterator]=p.prototype.entries)
...
o.test(this.url)?this.url=this.url.replace(o,"$1_="+(new Date).getTime()):this.url+=(/\?/.test(this.url)?"&":"?")+"_="+(new Date).getTime()}}function x(e){var t=new FormData
return e.trim().split("&").forEach((function(e){if(e){var n=e.split("="),r=n.shift().replace(/\+/g," "),i=n.join("=").replace(/\+/g," ")
t.append(decodeURIComponent(r),decodeURIComponent(i))}})),t}function E(e,t){if(!(this instanceof E))throw new TypeError('Please use the "new" operator, this DOM object constructor cannot be called as a function.')
t||(t={}),this.type="default",this.status=void 0===t.status?200:t.status,this.ok=this.status>=200&&this.status<300,this.statusText=void 0===t.statusText?"":""+t.statusText,this.headers=new p(t.headers),this.url=t.url||"",this._initBody(e)}k.prototype.clone=function(){return new k(this,{body:this._bodyInit})},y.call(k.prototype),y.call(E.prototype),E.prototype.clone=function(){return new E(this._bodyInit,{status:this.status,statusText:this.statusText,headers:new p(this.headers),url:this.url})},E.error=function(){var e=new E(null,{status:0,statusText:""})
...
try{new C}catch(e){(C=function(e,t){this.message=e,this.name=t
var n=Error(e)
this.stack=n.stack}).prototype=Object.create(Error.prototype),C.prototype.constructor=C}function _(e,t){return new Promise((function(n,i){var o=new k(e,t)
if(o.signal&&o.signal.aborted)return i(new C("Aborted","AbortError"))
var a=new XMLHttpRequest
function l(){a.abort()}a.onload=function(){var e,t,r={status:a.status,statusText:a.statusText,headers:(e=a.getAllResponseHeaders()||"",t=new p,e.replace(/\r?\n[\t ]+/g," ").split("\r").map((function(e){return 0===e.indexOf("\n")?e.substr(1,e.length):e})).forEach((function(e){var n=e.split(":"),r=n.shift().trim()
if(r){var i=n.join(":").trim()
t.append(r,i)}})),t)}
r.url="responseURL"in a?a.responseURL:r.headers.get("X-Request-URL")
var i="response"in a?a.response:a.responseText
setTimeout((function(){n(new E(i,r))}),0)},a.onerror=function(){setTimeout((function(){i(new TypeError("Network request failed"))}),0)},a.ontimeout=function(){setTimeout((function(){i(new TypeError("Network request failed"))}),0)},a.onabort=function(){setTimeout((function(){i(new C("Aborted","AbortError"))}),0)},a.open(o.method,function(e){try{return""===e&&r.location.href?r.location.href:e}catch(t){return e}}(o.url),!0),"include"===o.credentials?a.withCredentials=!0:"omit"===o.credentials&&(a.withCredentials=!1),"responseType"in a&&(s?a.responseType="blob":u&&o.headers.get("Content-Type")&&-1!==o.headers.get("Content-Type").indexOf("application/octet-stream")&&(a.responseType="arraybuffer")),!t||"object"!=typeof t.headers||t.headers instanceof p?o.headers.forEach((function(e,t){a.setRequestHeader(t,e)})):Object.getOwnPropertyNames(t.headers).forEach((function(e){a.setRequestHeader(e,d(t.headers[e]))})),o.signal&&(o.signal.addEventListener("abort",l),a.onreadystatechange=function(){4===a.readyState&&o.signal.removeEventListener("abort",l)}),a.send(void 0===o._bodyInit?null:o._bodyInit)}))}_.polyfill=!0,r.fetch||(r.fetch=_,r.Headers=p,r.Request=k,r.Response=E)}}])
